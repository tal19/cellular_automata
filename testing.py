...
c = np.array([[0, 1, 2, 3, 4, 3, 2, 1, 0],
              ...
              [-1, 15, 14, 13, 12, 13, 14, 15, -1],
              [-1, 16, 15, 14, 13, 14, 15, 16, -1],
              [-1, 17, 16, 15, 14, 15, 16, 17, -1],
              [-1, 16, 15, 14, 13, 14, 15, 16, -1],
              [-1, 15, 14, 13, 12, 13, 14, 15, -1],
              [-1, 14, 13, 12, 11, 12, 13, 14, -1],
              [-1, 13, 12, 11, 10, 11, 12, 13, -1],
              ...
              [-1, -1, -1, -1,  5, -1, -1, -1, -1],
              [0,  1,  2,  3,  4,  3,  2,  1,  0]])
o = np.array([[False, False, False, False, False, False, False, False, False],
              ...
              [False, False, False, False, False, False, False, False, False],
              [False, False, False, False, False, False, False, False, False]])
l = np.array([[Cell.EXIT, Cell.FLOOR, Cell.FLOOR, Cell.FLOOR, Cell.FLOOR, Cell.FLOOR, Cell.FLOOR, Cell.FLOOR, Cell.EXIT],
